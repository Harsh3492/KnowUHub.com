    ...
    <div class="row">
	   <div class="col-lg-12">
	    	<form action="./quizexam" method="post">
	           ...
	           <input type="hidden" value="9" name="question">  
			<a href="./Quiz8.jsp" class="btn btn-info pull-left button"><i class="glyphicon glyphicon-chevron-left"></i>Previous</a>
			<% 
		try{
			Class.forName("com.mysql.jdbc.Driver");
			cn=DriverManager.getConnection("jdbc:mysql://localhost/Knowuquiz?autoReconnect=true","root","12345");
			ps=cn.prepareStatement("Select count(QUESTION) from q"+rollno+" where QUESTION=9");
		    rs=ps.executeQuery();
		    rs.next();
			...
			{e.printStackTrace();}
			 ...
			 %> 
			<a href="./Quiz10.jsp" class="btn btn-info pull-right button">Next<i class="glyphicon glyphicon-chevron-right"></i></a>
			</form> 
			<hr class="line">
