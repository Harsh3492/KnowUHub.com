    ...
    <div class="row">
	   <div class="col-lg-12">
	    	<form action="./quizexam" method="post">
	           ...
	           <input type="hidden" value="14" name="question">
<a href="./Quiz13.jsp" class="btn btn-info pull-left button"><i class="glyphicon glyphicon-chevron-left"></i>Previous</a>
			<% 
		try{
			Class.forName("com.mysql.jdbc.Driver");
			cn=DriverManager.getConnection("jdbc:mysql://localhost/Knowuquiz?autoReconnect=true","root","12345");
			ps=cn.prepareStatement("Select count(QUESTION) from q"+rollno+" where QUESTION=14");
		    rs=ps.executeQuery();
		    rs.next();
			...
			{e.printStackTrace();}
			 %>			<a href="./Quiz15.jsp" class="btn btn-info pull-right button">Next<i class="glyphicon glyphicon-chevron-right"></i></a>			</form> 
			<hr class="line">
			 <a href="./Quiz1.jsp" class="btn btn-warning  option " >1</a>  
		  <a href="./Quiz2.jsp" class="btn warning option " >2</a>
